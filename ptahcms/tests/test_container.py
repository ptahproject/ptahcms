...
class TestContainer(PtahTestCase):
    ...
    def test_container_create(self):
        ...
        self.assertRaises(
            ptahcms.NotFound, container.create, 'unknown', 'test')

        tinfo = self.Content.__type__
        tname = tinfo.__uri__

        self.assertRaises(
            ptahcms.Forbidden, container.create, tname, 'test')

        tinfo.permission = None

        self.assertRaises(
            ptahcms.Error, container.create, tname, 'te/st')

        self.assertRaises(
            ptahcms.Error, container.create, tname, ' test')
        ...
        self.assertRaises(
            ptahcms.Error, container.create,
